...
import { Pr0miseAmbulanceWlEditor } from '../pr0mise-ambulance-wl-editor';
...
describe('Pr0mise-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [Pr0miseAmbulanceWlEditor],
      html: `<pr0mise-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></Pr0mise-ambulance-wl-editor>`,
    });
